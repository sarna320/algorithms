...
def main():
    ...
    list_of_all_heaps = (
        []
    )  # list for every k, example: list[0] holds list of all heaps for k=2 and for every list_entry[n]
    for k in range(2, 5):
        ...
        for i in number_of_data:
            ...
            list_of_heaps.append(
                x
            )  # we push current heap formed from list_entry for curren value from number_of_data[]
